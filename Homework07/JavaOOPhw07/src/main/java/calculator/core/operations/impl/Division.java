...
public class Division implements Operation {
    ...
    public String calculate(List<String> incNumbers) {
        ...
        result.add(0,(numbers.get(0) * numbers.get(2) + numbers.get(1) * numbers.get(3))
                /(numbers.get(2) * numbers.get(2) + numbers.get(3) * numbers.get(3)));
        result.add(1, (numbers.get(1) * numbers.get(2) - numbers.get(0) * numbers.get(3))
                /(numbers.get(2) * numbers.get(2) + numbers.get(3) * numbers.get(3)));
